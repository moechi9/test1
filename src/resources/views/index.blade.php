        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--text">
                    <input type="text" class="name" name="last_name" placeholder="例：山田" value="{{ old('last_name') }}" />
                    <input type="text" class="name" name="first_name" placeholder="例：太郎" value="{{ old('first_name') }}" />
                </div>
